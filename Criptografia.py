...
def firmar_documento(self, file_name):
    ...
    try:
        ...
        self.listWidget.addItem("Archivo '{}' firmado correctamente.".format(file_name))
...
def comprobar_firma(self, file_name, firma):
    ...
    try:
        ...
        self.listWidget.addItem("¡CORRECTO! La firma es válida.")

    except (ValueError, TypeError):
        self.listWidget.addItem("¡ERROR! La firma no es válida.")
...
def encrypt_file(self, key, in_filename, out_filename=None, chunksize=64*1024):
    try:
        ...
        self.listWidget.addItem("Encriptando fichero '{}'...".format(os.path.basename(in_filename)))

    except IOError:
        self.listWidget.addItem("encrypt_file: ¡ERROR! El fichero '{}' no existe".format(os.path.basename(in_filename)))

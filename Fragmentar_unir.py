...
def fragmentar(self, fromfile, chunksize=chunksize):
    ...
    while True:
        ...
        # Generamos los fragmentos con la extensión .enc y los almacenamos en el directorio.
    ...
    os.remove(fromfile)
    self.listWidget.addItem("Fragmentación finalizada: El archivo se dividió en {} partes.".format(partnum))
